...
\begin{defn}
  ...
  \end{align*}
  Then if $\underline m_j(E)=\overline m_j(E)$ we say that $E$ is \emph{Jordan measurable} and simply denote this common quantity by $m(E)$.
\end{defn}

It is immediate from the definition Jordan measure extends elementary measure in the sense that they agree on the elementary sets. Moreover, we will show that the Jordan measure inherits many of the properties of the elementary measure.
