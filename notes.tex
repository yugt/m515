...
\begin{proof}
  ...
  To begine the proof, note that given $f,g$ as in the theorem statement, we can rescale to assume that $\|f\|_p=\|g\|_q=1$. This is because both $\|\cdot\|_p$ and $\|\cdot\|_q$ satisfy the positive homogeneity property.
