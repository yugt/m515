...
\begin{figure}[h]
  ...
  \end{tikzpicture}
  \caption{On the left: An elementary set which is a union of two closed boxes. On the right: the elementary set shattered expressed as a disjoint union of seven open boxes, 20 open segments, and 14 points.}
...
\begin{exerc}
  Prove Proposition~\ref{prop:elementary-further}.
\end{exerc}
