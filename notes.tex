...
\begin{lem}
  Suppose that $E,F$ are finitely separated, that is, that $d(E,F)=\inf{d(x,y)\mid x\in E, y\in F}>0$. Then $m^*(E\cup F)=m^*(E)+m^*(F)$.
\end{lem}
