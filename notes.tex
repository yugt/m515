...
\begin{exerc}[See Tao, Ex 1.1.5]
  Complete the proof of Lemma~\ref{lem:jordan-equiv}: $E$ is Jordan measurable iff for all $\epsilon>0$ there is an elementary set $A$ such that $m(E\triangle A)<\epsilon$.
\end{exerc}
