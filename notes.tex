...
\begin{thm}[Fatou's lemma]
  Let $f_n$ be nonnegative measurable functions. Then $\int\liminf f_n\leq\liminf\int f_n$.
\end{thm}
...
The next theorem gives a very general and elegant way to prevent mass from escaping in a limit, namely, to make sure all functions involved are uniformly dominated by an absolutely integrable function.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Convergence theorems, part II}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
